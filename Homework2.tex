...
\Rightarrow~Var(\hat{f}(x\_0))+{[}Bias(\hat{f}(x\_0)){]}\^{}2
=~0\textbackslash{}\Rightarrow~Var(\hat{f}(x\_0))=-{[}Bias(\hat{f}(x\_0)){]}\^{}2
\textbackslash therefore,\textbackslash{}
{[}Bias(\hat{f}(x\_0)){]}\^{}2~\Uparrow~when~Var(\hat{f}(x\_0))~\{\Downarrow\}\textbackslash{}
Var(\hat{f}(x\_0))~\Uparrow~when~{[}Bias(\hat{f}(x\_0)){]}\^{}2~\Downarrow
\$\$
